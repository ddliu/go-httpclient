...
- `OPT_CONNECTTIMEOUT_D`: Time (with time.Duration) to wait while trying to connect. Use 0 to wait indefinitely.
...
- `OPT_TIMEOUT_D`: Maximum time (with time.Duration) to allow httpclient functions to execute.
